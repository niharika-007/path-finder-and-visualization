...
let algo = "A* Search";  // Default algorithm

// sourceColor = color(87, 50, 168)
// destColor = color(140, 68, 20)
function startAlgorithm() {

    start();  // This function will handle the algorithm initialization and start the loop
}
...
function dropdown(event, algorithm) {
    ...
    switch (algorithm) {
        case "A* Search":
            message.innerText = "Selected Algorithm: A* Search. Time Complexity: O((V + E) log V)";
            break;
        case "Dijkstra":
            message.innerText = "Selected Algorithm: Dijkstra. Time Complexity: O(V^2)";
            break;
        case "Breadth First Search":
            message.innerText = "Selected Algorithm: Breadth First Search. Time Complexity: O(V + E)";
            break;
        case "Depth First Search":
            message.innerText = "Selected Algorithm: Depth First Search. Time Complexity: O(V + E)";
            break;
        case "Greedy Best First Search":
            message.innerText = "Selected Algorithm: Greedy Best First Search. Time Complexity: O((V + E) log V)";
            break;
        default:
            message.innerText = "Selected Algorithm: Unknown";
    }
}
